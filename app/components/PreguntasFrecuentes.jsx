                ...
                <div class="max-w-screen-md mx-auto">
                    <div id="accordion-flush" data-accordion="collapse"
                        ...
                        <div id="accordion-flush-body-1" className={`${activeIndex === 1 ? 'block' : 'hidden'}`} aria-labelledby="accordion-flush-heading-1">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                <p class="mb-2 text-gray-500 dark:text-gray-400">
                                    ...
                                    <a href="/" class="text-red-500 dark:text-purple-500 hover:underline"> extintor
                                        adecuado</a>.
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="accordion-flush-body-2" className={`${activeIndex === 2 ? 'block' : 'hidden'}`} aria-labelledby="accordion-flush-heading-2">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                <p class="mb-2 text-gray-500 dark:text-gray-400">
                                    ...
                                    <a href="/" class="text-red-500 dark:text-purple-500 hover:underline"> extintor </a>
                        ...
                        <h3 id="accordion-flush-heading-3">
                            <button type="button"
                                class={`flex items-center justify-between w-full py-5 font-medium text-left ${activeIndex === 3 ? 'text-red-500 ' : 'text-gray-600'} border-gray-200 dark:border-gray-700 dark:text-gray-400`}
                        ...
                        <div id="accordion-flush-body-3" className={`${activeIndex === 3 ? 'block' : 'hidden'}`} aria-labelledby="accordion-flush-heading-3">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <ul class="pl-5 text-gray-500 list-disc dark:text-gray-400">
                                    <li>
                                        <a href="/" class="text-red-500 dark:text-purple-500 hover:underline">Recarga</a>
                                    </li>
                                    <li>
                                        <a href="/"
                                            class="text-red-500 dark:text-purple-500 hover:underline">Mantenimiento</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <h3 id="accordion-flush-heading-4">
                            <button type="button"
                                class={`flex items-center justify-between w-full py-5 font-medium text-left ${activeIndex === 4 ? 'text-red-500 ' : 'text-gray-600'} border-gray-200 dark:border-gray-700 dark:text-gray-400`}
                        ...
                        <div id="accordion-flush-body-4" className={`${activeIndex === 4 ? 'block' : 'hidden'}`} aria-labelledby="accordion-flush-heading-4">
                            <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <p class="mb-2 text-gray-500 dark:text-gray-400">
                                    ...
                                    <a href="/productos-servicios" class="text-red-500 dark:text-purple-500 hover:underline"> cursos de
                                        capacitacion </a>
